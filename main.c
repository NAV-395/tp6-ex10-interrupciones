...
cyhal_pwm_t pwm_obj;
int x=100;
static void button_isr1(void *handler_arg, cyhal_gpio_event_t event)
{
...
static void button_isr2(void *handler_arg, cyhal_gpio_event_t event)
{
	for(int i=0;i<5;i++){
...
static void button_isr3(void *handler_arg, cyhal_gpio_event_t event)
{
	cyhal_system_delay_ms(250);
	x-=20;
